...
public class Home extends AppCompatActivity {
    ...
    private void showNotification(String title, String message) {
        ...
        builder.setAutoCancel(true).setDefaults(Notification.DEFAULT_ALL).setWhen(System.currentTimeMillis()).setSmallIcon(R.mipmap.ic_launcher_round).setContentTitle(title).setContentText(message).setContentIntent(contentIntent);
