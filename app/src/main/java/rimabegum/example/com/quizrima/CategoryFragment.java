...
import rimabegum.example.com.quizrima.Model.Category;
import rimabegum.example.com.quizrima.ViewHolder.CategoryViewHolder;
    ...
    private void loadCategories() {
        adapter=new FirebaseRecyclerAdapter<Category, CategoryViewHolder>(Category.class,R.layout.category_layout,CategoryViewHolder.class,categories) {
            ...
            protected void populateViewHolder(CategoryViewHolder viewHolder, final Category model, int position) {
                ...
                Picasso.with(getActivity()).load(model.getResim()).into(viewHolder.category_image);
